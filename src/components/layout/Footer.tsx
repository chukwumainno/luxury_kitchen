      ...
      <div className="container py-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/support" className="text-gray-600 hover:text-primary text-sm">Support</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-semibold text-gray-800 mb-3">Legal</h3>
            <ul className="space-y-2">
              <li><Link href="/terms" className="text-gray-600 hover:text-primary text-sm">Terms</Link></li>
              <li><Link href="/privacy" className="text-gray-600 hover:text-primary text-sm">Privacy</Link></li>
              <li><Link href="/cookies" className="text-gray-600 hover:text-primary text-sm">Cookies</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-200 pt-4 mt-2">
          <p className="text-sm text-gray-500 text-center">
            © {new Date().getFullYear()} Luxury Kitchen. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
